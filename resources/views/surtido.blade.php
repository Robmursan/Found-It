...
@section('content')
    ...
    @push('scripts')
    <script>
        function openSurtirModal(codigo = '') {
            document.getElementById('surtirCodigo').value = codigo;
            document.getElementById('surtirCantidad').value = '';
            document.getElementById('surtirModal').classList.remove('hidden');
        }

        function closeSurtirModal() {
            document.getElementById('surtirModal').classList.add('hidden');
        }

        function confirmarSurtido() {
            let codigo = document.getElementById('surtirCodigo').value;
            let cantidad = document.getElementById('surtirCantidad').value;
            ...
            // Aquí iría la lógica para procesar la salida del material
            console.log(`Material ${codigo} surtido con cantidad ${cantidad}`);
            closeSurtirModal();
        }
    </script>
    @endpush
